    ...
    private Customer inputNewCustomerInfo(int selectedDetail, Customer customer) {
        ...
        switch (selectedDetail){
            ...
            case 8:
                ...
                diseaseHistory.setId("DH" + (this.cDiseaseHistory.getMaxID()+1));   //
            ...
            case 9:
                ...
                ownedBuildingInfo.setId("BI" + (this.cOwnedBuildingInfo.getMaxID()+1)); //
            ...
            case 10:
                ...
                ownedCarInfo.setId("CI" + (this.cOwnedCarInfo.getMaxID()+1));    //
